                    ...
                    <table class="timetable table table-striped ">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td class= "timetable-class" onclick="showModule('GRP')">Software Engineering Group Project<br>-Tutorial</td>
                                <td></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="timetable-class" onclick="showModule('SWM')">Software Maintance<br>-Labs</td>
                                <td></td>
                                <td class="timetable-class" onclick="showModule('OSC')">Operating System and Concurrency<br>-Lecture</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="timetable-class" onclick="showModule('SWM')">Software Maintance<br>-Lecture</td>
                                <td></td>
                                <td></td>
                                <td></td>
                                <td></td>
                            ...
                            <tr>
                                ...
                                <td class="timetable-class" onclick="showModule('SWM')">Software Maintance<br>-Lecture</td>
                                <td class="timetable-class" onclick="showModule('ACE')">Algorithms Correctness and Efficiency<br>-Tutorial</td>
                                <td></td>
                                <td class="timetable-class" onclick="showModule('SWM')">Software Maintance<br>-Lecture</td>
                                <td></td>
                            <tr>
